                ...
                >
                    <div className="text-center mb-16 md:mb-20">
                        <motion.h1 variants={cardVariants} className="text-4xl md:text-5xl lg:text-5xl font-bold mb-6">
                            Internship <span className="text-[var(--color-primary-500)]">Experiences</span>
                        </motion.h1>
                        <motion.p variants={cardVariants} className="text-gray-600 dark:text-gray-400 max-w-4xl mx-auto text-lg md:text-xl pt-2 leading-relaxed">
                            This section contains documentation, activities, and experiences completed during the finance internship program, including administrative tasks, financial document management, data input processes, and workplace activities.
                        </motion.p>
                    </div>
                            ...
                            >
                                <div className="relative overflow-hidden aspect-video">
                                    <img
                                        src={item.image}
                                        alt={item.title}
                                        className={`w-full h-full object-cover ${item.position || 'object-center'} transition-transform duration-500 group-hover:scale-105`}
                                    />
