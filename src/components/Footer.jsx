            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="text-center md:text-left">
                        <a href="#" className="text-2xl font-bold bg-gradient-to-r from-[var(--color-primary-500)] to-[#f43f5e] bg-clip-text text-transparent inline-block mb-2">
                            Portofolio.
                        </a>
                    ...
                    <div className="flex space-x-6">
                        <a href="#" className="w-10 h-10 rounded-full bg-gray-50 dark:bg-gray-800/50 flex items-center justify-center text-gray-500 dark:text-gray-400 hover:text-[var(--color-primary-500)] hover:bg-[var(--color-primary-50)] dark:hover:bg-pink-900/30 transition-all">
